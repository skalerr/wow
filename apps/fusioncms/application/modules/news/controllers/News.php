...
class News extends MX_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('rankings/rankings_model');
    ...
    private function displayPage()
    {
        ...
        if ($realms) {
            ...
            $this->server_model->setRealm($realmId);
            $this->rankings_model->setRealm($realmId);

            $home_portal = $this->template->loadPage("home_portal.tpl", [
                "url" => $this->template->page_url,
                "homeRealmId" => $realmId,
                "realmCards" => $this->server_model->getRealmCards(),
                "recentCaps" => $this->server_model->getNewLevelCaps(5),
                "realmFirsts" => $this->server_model->getRealmFirsts(5),
                "topPlayers" => array_slice($this->rankings_model->getTopLevelPlayers(10), 0, 5),
                "topGuilds" => array_slice($this->rankings_model->getTopGuilds(10), 0, 5),
