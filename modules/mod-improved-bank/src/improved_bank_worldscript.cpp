...
public:
    ...
    void OnAfterConfigLoad(bool reload) override
    {
        ...
        if (!reload)
        {
            sImprovedBank->SetCategorizedItemMenuDeposit(sConfigMgr->GetOption<bool>("ImprovedBank.Categorized.Item.Menu.Deposit", true));
            sImprovedBank->SetCategorizedItemMenuWithdraw(sConfigMgr->GetOption<bool>("ImprovedBank.Categorized.Item.Menu.Withdraw", true));
        }
    }
};
